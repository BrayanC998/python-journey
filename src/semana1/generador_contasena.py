...
ruta_archivo = os.path.join(ruta_carpeta, "passwords.txt") # revisa si existe el nombre del archivo o crea si no existe y escribe el resultado ahi

fecha_hora = datetime.now().strftime("%Y-%m-%d %H:%M:%S") #Guarda la fecha y la hora del comento de guardar la contraseña
