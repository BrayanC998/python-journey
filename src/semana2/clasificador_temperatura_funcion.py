...
def clasificar_temperatura(temperatura): #aqui la variable temperatura es la que se ingresar y se guarda
            if temperatura <= 0:
...
while True:
    try:
        ...
        resultado_definicion_temperatura = clasificar_temperatura(grados_temperatura) #secambia variable temperatura por grados_temperatura para leerla variable de ingreso tambien.
